...
os.system('mkdir '+native_mnc+'/ADT/')
native_l = native_mnc+'/ADT/lh.smoothwm.native.mask.mnc'
native_r = native_mnc+'/ADT/rh.smoothwm.native.mask.mnc'

native_scan_l = native_mnc+'/ADT/lh.smoothwm.native.scan.mnc'
native_scan_r = native_mnc+'/ADT/rh.smoothwm.native.scan.mnc'

depth_l = native_mnc+'/lh.smoothwm.native_81920.depth'
depth_r = native_mnc+'/rh.smoothwm.native_81920.depth'

surf_l_coord = native_mnc+'/ADT/lh.smoothwm.native.coord.obj'
surf_r_coord = native_mnc+'/ADT/rh.smoothwm.native.coord.obj'
surf_l = native_mnc+'/lh.smoothwm.native_81920.obj'
surf_r = native_mnc+'/rh.smoothwm.native_81920.obj'
