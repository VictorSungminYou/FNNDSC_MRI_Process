...
def _extract_wm_mesh(segmentation, output_wm, hemi, taubin, subsampling, convert='yes'):
	...
	os.system('python3 /neuro/labs/grantlab/research/MRI_processing/andrea.gondova/Scripts/CP_SP_coevolution/CP_surface_extraction/src/1_Inner_CP_surface_v0.0.py \
			--input_seg={} \
			--output_surface={} \
			--label={} \
			--side={} \
